...
<div style="width:90%;margin:0 auto;padding-bottom: 50px;">
    @if ($projectId == 59)
        <a href="https://laitklimat.ru"><img src="http://projects-backend.ru/uploads/logos/laitklimat.jpg"></a>
    @else
        <a href="https://xolodnoeleto.ru"><img src="http://projects-backend.ru/uploads/logos/xolod.png"></a>
    @endif
    ...
    @if ($projectId == 59)
        <p style="margin-top: 60px;"><img src="http://projects-backend.ru/uploads/logos/light_climat.png" style="width:530px;"></p>
    @endif
